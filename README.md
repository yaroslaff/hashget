...
Also, please check my other open-source project [Okerr](https://github.com/yaroslaff/okerr-dev). And [Okerr documentation (Eng)](https://okerr.readthedocs.io/en/latest/) and [Okerr documentation (Rus)](https://okerr.readthedocs.io/ru/latest/).
